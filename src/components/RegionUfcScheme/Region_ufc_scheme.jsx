                        ...
                        <div className="card" style={{ borderRadius: "10px 10px 10px 10px " }}>
                            ...
                            <div>
                                <table class="table table-bordered table-sm">                               
                                    <tbody>
                                        <tr>
                                            <td className="text-end p-2"><b>Start Date</b></td>
                                            <td> <input type="date" className="form-control" /></td>
                                            <td className="text-end p-2"><b>End Date</b></td>
                                            <td > <input type="date" className="form-control " /></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>Asset Class</b></td>
                                            <td> <select className="form-select">
                                                <option>Select</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>Channel</b></td>
                                            <td> <select className="form-select" value="RTL">
                                                <option value="RTL">RTL</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>Zone</b></td>
                                            <td> <select className="form-select">
                                                <option>Select</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>Region</b></td>
                                            <td> <select className="form-select">
                                                <option>Select</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>Location/UFC</b></td>
                                            <td> <select className="form-select">
                                                <option>Select</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td className="text-end p-2"><b>RM Name</b></td>
                                            <td> <select className="form-select">
                                                <option>Select</option>
                                            </select></td>
                                        </tr>
